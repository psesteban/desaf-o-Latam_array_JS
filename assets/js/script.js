...
if (document.querySelector("#all")) {
  ...
  console.log("muestra las casas y departamentos disponibles");
}
...
if (rowPropiedadesVenta) {
  functionInner(propiedadesVenta);
} else {
